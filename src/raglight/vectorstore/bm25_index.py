...
class BM25Index:
    ...
    def add_documents(self, texts: List[str], metadatas: Optional[List[Dict[str, Any]]] = None) -> None:
        ...
        # Ensure metadatas length matches texts
    ...
    def search(self, query: str, k: int) -> List[Tuple[int, float, str, Dict[str, Any]]]:
        """
        Search the BM25 index and return results with metadata.
